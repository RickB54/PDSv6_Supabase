...
export const addOns: AddOn[] = [
  ...
  { 
    ...
    category: 'exterior', 
    description: 'Our flagship Professional Nano Ceramic Coating. Following extensive paint prep, this hard-curing quartz coating is applied to deliver 2+ years of maximum gloss, intense hydrophobic protection, and unmatched resistance to environmental damage.', 
    basePrice: 299, 
  ...
  },
  {
    ...
    category: 'interior',
    description: 'An additional interior detail extension required for vehicles equipped with a third row of seating. This covers the extra time and labor needed to thoroughly vacuum, clean, and detail the rear-most passenger area and cargo space.',
    basePrice: 50,
