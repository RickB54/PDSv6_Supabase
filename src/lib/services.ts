...
export const addOns: AddOn[] = [
  ...
  { id: 'ceramic-coating-6mo', name: '6-Month Ceramic Coating', category: 'exterior', description: "A professional application of our Cover All ceramic coating, delivering durable hydrophobic protection and brilliant gloss for a full 6 months — no follow-up required. If you'd like to extend your protection to a full year, simply return around the 6-month mark for a follow-up application using our ceramic coating extender; the extension is priced the same as your original visit.", basePrice: 350, pricing: { compact: 350, midsize: 400, truck: 450, luxury: 500 }, active: true },
  { 
...
• Luxury/High-End: ~2.75 hrs | $275`, 
  ...
  { id: 'ceramic-protection-2yr-plan', name: '2-Year Ceramic Protection Plan', category: 'exterior', description: "Our full ceramic coating application, paired with a 2-year enrollment in scheduled booster maintenance visits to refresh hydrophobicity, restore gloss, and extend the coating's real-world performance well beyond its base rating. Ideal for customers who want longer-term protection and the convenience of us handling upkeep on a set schedule.", basePrice: 650, pricing: { compact: 650, midsize: 800, truck: 950, luxury: 1150 }, active: true },
  { id: 'clay-bar', name: 'Clay Bar & Iron Decontamination', category: 'exterior', description: 'A professional deep decontamination process using specialized clay to pull embedded contaminants, industrial fallout, and iron particles from the clear coat, leaving the paint as smooth as glass.', basePrice: 88, pricing: { compact: 88, midsize: 99, truck: 110, luxury: 132 }, active: true },
  { id: 'ceramic-trim-coat', name: 'Ceramic Trim Coat Restoration', category: 'exterior', description: 'Advanced restoration and protection for faded exterior plastics. We strip old dressings and apply a true ceramic coating that permanently bonds to the trim, restoring deep, rich color and providing long-lasting UV defense.', basePrice: 66, pricing: { compact: 66, midsize: 83, truck: 105, luxury: 138 }, active: true },
  { id: 'deep-interior', name: 'Deep Interior Detail', category: 'interior', description: 'The ultimate interior reset. Includes intensive steam cleaning, deep shampooing and hot-water extraction of all carpets and fabric seats, and meticulous detailing of every crevice, vent, and compartment.', basePrice: 165, pricing: { compact: 165, midsize: 193, truck: 220, luxury: 248 }, active: true },
...
export function getCanonicalAddonName(input: string): string {
  ...
  if (lowerInput.includes('ceramic protection')) return '2-Year Ceramic Protection Plan';
