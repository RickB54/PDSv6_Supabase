...
export function PageHeader({ title, subtitle, children }: PageHeaderProps) {
  ...
  return (
    <>
      <header className={`fixed ${isDemoMode ? 'top-10' : 'top-0'} left-0 right-0 z-40 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60`}>
