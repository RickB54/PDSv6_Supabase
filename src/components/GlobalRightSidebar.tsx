...
const renderSidebarContent = (
    ...
    if (activeMode === 'customer') {
        return (
            <>
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/customer-dashboard')} title="Customer Dashboard" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <LayoutDashboard className="w-5 h-5 text-blue-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Dashboard</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/services')} title="Book A Job" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <CalendarDays className="w-5 h-5 text-emerald-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Book A Job</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/contact-support')} title="Contact Support" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <MessageSquare className="w-5 h-5 text-cyan-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Support</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/active-jobs')} title="Active Jobs" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <Clock className="w-5 h-5 text-amber-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Active Jobs</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/job-history')} title="Job History" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <History className="w-5 h-5 text-green-500" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Job History</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/payments-cart')} title="Payments & Cart" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <ShoppingCart className="w-5 h-5 text-purple-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Payments</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/my-invoices')} title="My Invoices" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <FileText className="w-5 h-5 text-blue-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">My Invoices</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/my-estimates')} title="My Estimates" className={collapsed ? "" : "w-full justify-start gap-2"}>
                ...
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/sticky-notes')} title="Sticky Notes" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <CheckSquare className="w-5 h-5 text-yellow-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Sticky Notes</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/blog')} title="Prime Blog" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <Newspaper className="w-5 h-5 text-indigo-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Prime Blog</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/user-settings')} title="User Settings" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <Settings className="w-5 h-5 text-zinc-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Settings</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction(() => window.open('https://primeautodetail.net', '_blank'))} title="Prime Website" className={collapsed ? "" : "w-full justify-start gap-2"}>
    ...
    if (activeMode === 'employee') {
        return (
            <>
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/dashboard/employee')} title="Employee Dashboard" className={collapsed ? "" : "w-full justify-start gap-2"}>
                ...
                <Button
                    ...
                    onClick={() => handleAction(() => window.dispatchEvent(new Event('open-quick-pay')))}
                ...
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/vehicle-gallery')} title="Vehicle Gallery" className={collapsed ? "" : "w-full justify-start gap-2"}>
                ...
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/staff-schedule')} title="Staff Schedule" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <CalendarDays className="w-5 h-5 text-emerald-500" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Schedule</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/bookings')} title="Bookings" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <Calendar className="w-5 h-5 text-purple-500" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Bookings</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/service-checklist')} title="Service Checklist" className={collapsed ? "" : "w-full justify-start gap-2"}>
                ...
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/training-manual?tab=process')} title="Standard Operating Procedures (SOPs)" className={collapsed ? "" : "w-full justify-start gap-2"}>
                ...
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/tasks')} title="Tasks" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <CheckSquare className="w-5 h-5 text-blue-500" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Tasks</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/mileage')} title="Mileage" className={collapsed ? "" : "w-full justify-start gap-2"}>
                ...
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/chemicals')} title="Chemicals" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <FlaskConical className="w-5 h-5 text-teal-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Chemicals</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction(() => window.dispatchEvent(new CustomEvent('open-ricks-tips', { detail: { tab: 'description' } })))} title="Chemical Description" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <BookOpen className="w-5 h-5 text-purple-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Chem Desc</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/dilution-calculator')} title="Dilution Calculator" className={collapsed ? "" : "w-full justify-start gap-2"}>
                ...
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction(() => window.dispatchEvent(new Event('open-static-caddy')))} title="Static Caddy Worksheet" className={collapsed ? "" : "w-full justify-start gap-2"}>
                ...
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/mobile-setup')} title="Mobile Setup" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <Package className="w-5 h-5 text-cyan-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Mobile Setup</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/shop-setup')} title="Shop Setup" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <Package className="w-5 h-5 text-indigo-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Shop Setup</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/learning-library')} title="Learning Library" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    <GraduationCap className="w-5 h-5 text-indigo-400" />
                    {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Learning</span>}
                </Button>

                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/user-settings')} title="My Profile" className={collapsed ? "" : "w-full justify-start gap-2"}>
    ...
    return (
        <>
            ...
            {!isDemoMode && (
                <>
                    <Button
                        variant="ghost"
                        size={collapsed ? "icon" : "default"}
                        onClick={() => handleAction(() => window.dispatchEvent(new Event('open-call-assistant')))}
                    ...
                    <Button
                        variant="ghost"
                        size={collapsed ? "icon" : "default"}
                        onClick={() => handleAction(() => window.dispatchEvent(new Event('open-comm-guide')))}
            ...
            <Button 
                variant="ghost" 
                size={collapsed ? "icon" : "default"} 
                onClick={() => handleAction(() => window.dispatchEvent(new Event('open-pre-vehicle-checklist')))} 
            ...
            {isAdmin && !isDemoMode && (
                <Button
                    variant="ghost"
                    size={collapsed ? "icon" : "default"}
                    onClick={() => handleAction('/availability-manager')}
            ...
            <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/service-checklist')} title="Checklist" className={collapsed ? "" : "w-full justify-start gap-2"}>
                <ClipboardList className="w-5 h-5 text-orange-500" />
                {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase truncate">Checklist</span>}
            </Button>
            ...
            {isAdmin && (
                <>
                    ...
                    <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/payments')} title="Payments" className={`group relative ${collapsed ? "" : "w-full justify-start gap-2"} hover:bg-green-500/10`}>
                    ...
                    <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/estimates')} title="Estimates" className={collapsed ? "" : "w-full justify-start gap-2"}>
                        <FileText className="w-5 h-5 text-yellow-500" />
                        {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase">Estimates</span>}
                    </Button>

                    <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/invoicing')} title="Invoices" className={collapsed ? "" : "w-full justify-start gap-2"}>
                        <Receipt className="w-5 h-5 text-blue-400" />
                        {!collapsed && <span className="text-white font-black text-[10px] tracking-widest uppercase">Invoices</span>}
                    </Button>

                    <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/accounting')} title="Accounting" className={`group relative ${collapsed ? "" : "w-full justify-start gap-2"} hover:bg-emerald-500/10`}>
            ...
            {isAdmin && (
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/search-customer')} title="Customer Database" className={collapsed ? "" : "w-full justify-start gap-2"}>
            ...
            {isAdmin && (
                <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/prospects')} title="Prospects Overview" className={collapsed ? "" : "w-full justify-start gap-2"}>
            ...
            {isAdmin && (
                <>
                    <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/company-employees')} title="Company Employees" className={collapsed ? "" : "w-full justify-start gap-2"}>
                    ...
                    <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/follow-up-center')} title="Follow-Up Center" className={collapsed ? "" : "w-full justify-start gap-2"}>
            ...
            {isAdmin && (
                <>
                    <Button variant="ghost" size={collapsed ? "icon" : "default"} onClick={() => handleAction('/inventory-control')} title="Inventory" className={collapsed ? "" : "w-full justify-start gap-2"}>
