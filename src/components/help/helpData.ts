...
export const adminMenuTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    content: [
      '**Overview**: The Dilution Reference Chart is a high-contrast shop guide designed to eliminate mixing errors. It provides exact measurements for both chemical and water components.',
      '',
      '🧪 **Chemical & Water (C & W)**:',
      '• **Detailed Breakdown**: Every row shows the **Chemical Amount (C)** and the **Water Amount (W)** side-by-side.',
      '• **Large Text**: Numbers are doubled in size and printed in bold black to ensure they can be read from across the shop floor.',
      '',
      '🏁 **Vertical Separator Lines**:',
      '• **B&W Visibility**: We have added thin vertical separator lines between the color-coded scenarios. This ensures that even when printed on a black-and-white printer, you can clearly distinguish where one scenario ends and the next begins.',
      '',
      '📊 **Supported Sizes & Scenarios**:',
      '• **Standard / More Conc (Heavy) / Less Conc (Light)**: Three levels of cleaning power for every chemical.',
      '• **32oz / 24oz / 16oz**: Calculations for all standard workshop spray bottles.',
      '',
      '🎯 **Where to Find It**: Access the chart via the "DILUTION REF CHART" button in the Chemical Cards, Inventory Control, or under the Prime Training Center menu.',
    ],
