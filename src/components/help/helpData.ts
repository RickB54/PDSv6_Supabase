...
export const adminMenuTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    summary: 'High-visibility mix guide for all shop chemicals across multiple bottle sizes.',
    content: [
      '**Overview**: The Dilution Reference Chart is a high-contrast, large-format guide designed for the mix station. It eliminates math errors by showing the exact ounces needed for various containers.',
      '',
      '🧪 **Chemical vs. Water (C/W)**:',
      '• Each cell identifies the **Chemical Amount (C)** and the **Water Amount (W)** separately.',
      '• Values are calculated for **16oz**, **24oz**, and **32oz** detailing bottles.',
      '',
      '📊 **Three Soil Scenarios**:',
      '• **Standard**: The daily maintenance dilution recommended by the manufacturer.',
      '• **More Conc (Heavy)**: Stronger mix for deep cleaning or severe contamination.',
      '• **Less Conc (Light)**: Thinner mix for delicate surfaces or light dusting.',
      '',
      '🔍 **Accessibility Features**:',
      '• **Large Format**: Text size is doubled for easy reading in busy shop environments.',
      '• **High Contrast**: Solid black numbers and bold dividers ensure clarity on printed copies.',
      '• **Smart Ratios**: All data is pulled live from the **Chemical Library**, ensuring your shop charts never go out of date.',
      '',
      '🖨️ **Printing & Export**:',
      '• Use the **PDF** button to save a digital copy or the **Print** icon to send it directly to your shop printer.',
      '• The chart is accessible from the **Chemical Cards** header and the **Prime Training Center** menu.',
    ],
