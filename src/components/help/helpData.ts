...
export const adminMenuTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '**Reporting & Charts**: Generate full inventory PDFs or use the "Quick Reference Chart" to print a simplified, high-visibility dilution guide for your mix station. Perfect for laminating and posting at your shop.',
      '',
