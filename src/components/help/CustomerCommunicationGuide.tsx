          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                <li><span className="font-medium">Basic Info:</span> "What kind of vehicle are we looking at? Year, make, and model?"</li>
            ...
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 shadow-sm">
              ...
              <div className="space-y-2 text-xs font-mono">
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Year/Make/Model:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Color:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Interior Mat.:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Interior Cond.:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Paint Cond.:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Overall Dirt:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Usage/Storage:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Last Detail:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
                <div className="flex border-b border-slate-200 pb-1">
                  <span className="w-1/3 text-slate-500">Goal/Motivation:</span>
                  <span className="w-2/3 text-slate-900 border-b border-dashed border-slate-300"></span>
                </div>
              </div>
              <p className="mt-3 text-[10px] text-slate-400 italic text-center">Use one card per vehicle.</p>
            </div>
          </div>
        </div>
      )
        ...
        <div className="space-y-4 text-sm text-slate-700">
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="p-3 bg-slate-50 rounded border border-slate-200">
              ...
              <p className="text-slate-600 mt-1">A: "We base it on the actual size and surface area. For example, a 3-row SUV requires significantly more time and product than a 2-door coupe, so the pricing reflects that."</p>
            </div>
            <div className="p-3 bg-slate-50 rounded border border-slate-200">
              <p className="font-bold text-slate-800">Q: How long does a detail take?</p>
              <p className="text-slate-600 mt-1">A: "It varies heavily by condition. A standard full detail is usually 4-6 hours. If we are dealing with heavy pet hair or severe staining, I might need it for the full day."</p>
            </div>
            <div className="p-3 bg-slate-50 rounded border border-slate-200">
            ...
            <div className="p-4 bg-amber-50 rounded-lg border border-amber-200 mt-2">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-amber-900 italic text-sm">"I completely understand. Our pricing reflects the level of detail, professional-grade equipment, and time we dedicate to your vehicle. We focus on high-quality, lasting results rather than a quick surface wash, ensuring you get the best value for your investment."</p>
                </div>
                <div>
