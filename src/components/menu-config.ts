    ...
    tentativeBookingsCount: number;
        ...
        },
        {
            ...
            items: [
                ...
                { title: "Chemical Workflow", url: "/chemical-training", key: "chem-train", icon: Beaker, helpTopicId: 'chem-train' },
        ...
        },
        {
            ...
            items: [
                ...
                { title: "Blog Layout Architect", url: "/blog-reorder", role: "admin", key: "blog-reorder", icon: ListOrdered, helpTopicId: 'blog-reorder' },
            ]
        },
        {
