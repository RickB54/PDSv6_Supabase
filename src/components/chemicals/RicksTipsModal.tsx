...
import { Search, Save, Package, FlaskConical, Trash2, Plus, Info, Zap, Check, CheckSquare, List, MessageSquare, Droplets, BookOpen, Printer, FileText, RefreshCw, HelpCircle, X, Maximize2, Minimize2 } from 'lucide-react';
...
export default function RicksTipsModal({ open, onOpenChange, initialTab = 'package' }: { open: boolean, onOpenChange: (open: boolean) => void, initialTab?: 'package' | 'description' | 'prep' }) {
  ...
  const seedChemicalData = (chems: any[], currentDescs: ChemicalDescription[], currentPrep: string[], currentTips: TipMapping[]): { seededDescs: ChemicalDescription[], seededPrep: string[], seededTips: TipMapping[], changed: boolean } => {
    ...
    const exteriorChemNames = ["Dark Fury", "Dirt Buster", "Muscle Magic", "Road Warrior", "Gold Class", "Cherry Foam", "Formula 4", "APC"];
    const interiorChemNames = ["Does It All", "Pink Perfection", "Green All", "Carpet Bomber", "Terminator", "Zap It", "Xpress", "Cover All", "Invisible Glass", "Dirt Buster"];
    ...
    const fullIds = Array.from(new Set([...exteriorIds, ...interiorIds]));

    const packageAdvice = [
      { 
        id: 'prime-essential-exterior', 
        chemIds: exteriorIds,
        notes: `Essential Exterior Guide — Step by Step:\n\n1. Wheels & Tires First\n   - Dark Fury 4:1 (light) or 7:1 (heavy)\n   - Agitate with wheel/barrel/lug brush\n   - Rinse immediately — no dwell on metal or chrome\n   - Engine Bay addon: do engine first, cover electronics, rinse, dry before wheels\n\n2. Pre-Rinse\n   - Top to bottom always\n   - Open doors slightly to flush jambs\n   - Skip if clean maintenance detail\n\n3. Pre-Treat Bugs & Heavy Grime\n   - Road Warrior 4:1 on dry surface\n   - Dwell 3-5 min MAX — do not let dry on paint\n   - Focus: front grill, hood, lower front panels\n   - Alternatives: Muscle Magic (heavy grime), Dirt Buster (concentrated spots)\n\n4. Foam Bath\n   - Meguiar's Gold Class 5:1 or Cherry Foam 5:1\n   - Dwell 3-5 min — mist if drying before time is up\n   - Never let foam dry on paint — work in shade\n\n5. Hand Wash (Top to Bottom)\n   - Multiple microfiber towels — flip to clean side each panel\n   - Top to bottom, driver's side front to back, passenger side back to front\n   - Straight strokes only — never circular\n   - Never use wheel/lower panel towel on paint\n\n6. Final Rinse\n   - Top to bottom thoroughly\n   - Clay Bar addon: clay immediately after rinse while paint is wet\n   - Use APC as lubricant, fold clay frequently\n\n7. Drying\n   - Formula 4 at 20:1 sprayed on wet paint\n   - Open all jambs/trunk/hood — dry those too\n   - Formula 4 = drying aid + 2-5 week protection in one step\n\n8. Paint Protection\n   - Formula 4 already applied during drying — dual purpose\n   - No additional product needed for Essential packages` 
      },
      { 
        id: 'prime-essential-interior', 
        chemIds: interiorIds,
        notes: `Essential Interior Guide — Step by Step:\n\n1. Remove Personal Items & Trash\n   - Remove and set aside safely before starting anything\n\n2. Vacuum (Top to Bottom)\n   - Blow out vents/seat tracks/under seats with air first\n   - Remove floor mats before vacuuming\n   - Work rear to front, crevice tool for tight areas\n\n3. Floor Mats\n   - Drill brush — match brush size/pressure to mat type\n   - Primary: Carpet Bomber 7:1 (std) or 5:1 (heavy) + Terminator\n   - Backup: Zap It\n   - Organic stains: Does It All Enzyme Cleaner — dwell 3-5 min, agitate, wipe\n   - Set aside to dry completely before reinstalling\n\n4. Dashboard, Steering Wheel & Console\n   - Does It All Enzyme Cleaner or Pink Perfection 10:1\n   - Detail brush for vents, button gaps, seams\n   - Driver's side front to back, passenger side back to front\n\n5. Interior Plastics / Vinyl / Trim\n   - Pink Perfection 10:1 general cleaning\n   - Does It All Enzyme Cleaner for organic stains\n   - Green All for general plastics\n   - Soft brush for crevices\n\n6. Fabric / Carpet / Seats\n   - Carpet Bomber 7:1 (std) or 5:1 (heavy)\n   - Organic stains: Does It All Enzyme Cleaner — dwell 3-5 min, agitate, blot\n   - Straight strokes only with drill brush — never circular\n   - Pet hair tools BEFORE any chemical if hair present\n   - Extractor for Deep Interior Detail or Stain Treatment addon\n\n7. Interior Protectant / Plastics Finisher\n   - P&S Xpress 3:1 or Cover All 4:1\n   - Apply to all plastics/vinyl/trim\n   - Do BEFORE windows so overspray is caught in glass step\n   - If done last: keep away from windshield, screens, electronics\n\n8. Windows & Glass\n   - Invisible Glass on towel only — never spray directly on glass\n   - Two-pass method: first removes film, second clears streaks\n   - Dedicated glass towels only — never shared\n   - Check windshield from multiple angles for haze\n\n9. Door Jambs & Trunk Jambs\n   - Dirt Buster or APC at appropriate dilution\n   - Detail brush for hinges and tight corners\n   - Dry thoroughly — water in jambs drips on paint later\n   - Include hood jamb, trunk jamb, all four door jambs\n\n10. Final Inspection\n    - Sit in driver's seat — check windshield from multiple angles\n    - Confirm jambs clean and dry\n    - Floor mats reinstalled correctly\n    - Interior smells clean, not chemical` 
      },
      { 
        id: 'prime-essential-full', 
        chemIds: fullIds,
        notes: `Full Detail Guide — Exterior First, Then Interior:\n\n— EXTERIOR —\n\n1. Wheels & Tires First\n   - Dark Fury 4:1 (light) or 7:1 (heavy)\n   - Agitate with wheel/barrel/lug brush\n   - Rinse immediately — no dwell on metal or chrome\n   - Engine Bay addon: do engine first, cover electronics, rinse, dry before wheels\n\n2. Pre-Rinse\n   - Top to bottom always\n   - Open doors slightly to flush jambs\n   - Skip if clean maintenance detail\n\n3. Pre-Treat Bugs & Heavy Grime\n   - Road Warrior 4:1 on dry surface\n   - Dwell 3-5 min MAX — do not let dry on paint\n   - Focus: front grill, hood, lower front panels\n   - Alternatives: Muscle Magic (heavy grime), Dirt Buster (concentrated spots)\n\n4. Foam Bath\n   - Meguiar's Gold Class 5:1 or Cherry Foam 5:1\n   - Dwell 3-5 min — mist if drying before time is up\n   - Never let foam dry on paint — work in shade\n\n5. Hand Wash (Top to Bottom)\n   - Multiple microfiber towels — flip to clean side each panel\n   - Top to bottom, driver's side front to back, passenger side back to front\n   - Straight strokes only — never circular\n   - Never use wheel/lower panel towel on paint\n\n6. Final Rinse\n   - Top to bottom thoroughly\n   - Clay Bar addon: clay immediately after rinse while paint is wet\n   - Use APC as lubricant, fold clay frequently\n\n7. Drying\n   - Formula 4 at 20:1 sprayed on wet paint\n   - Open all jambs/trunk/hood — dry those too\n   - Formula 4 = drying aid + 2-5 week protection in one step\n\n8. Paint Protection\n   - Formula 4 already applied during drying — dual purpose\n   - No additional product needed for Essential packages\n\n— INTERIOR —\n\n9. Remove Personal Items & Trash\n   - Remove and set aside safely before starting anything\n\n10. Vacuum (Top to Bottom)\n    - Blow out vents/seat tracks/under seats with air first\n    - Remove floor mats before vacuuming\n    - Work rear to front, crevice tool for tight areas\n\n11. Floor Mats\n    - Drill brush — match brush size/pressure to mat type\n    - Primary: Carpet Bomber 7:1 (std) or 5:1 (heavy) + Terminator\n    - Backup: Zap It\n    - Organic stains: Does It All Enzyme Cleaner — dwell 3-5 min, agitate, wipe\n    - Set aside to dry completely before reinstalling\n\n12. Dashboard, Steering Wheel & Console\n    - Does It All Enzyme Cleaner or Pink Perfection 10:1\n    - Detail brush for vents, button gaps, seams\n    - Driver's side front to back, passenger side back to front\n\n13. Interior Plastics / Vinyl / Trim\n    - Pink Perfection 10:1 general cleaning\n    - Does It All Enzyme Cleaner for organic stains\n    - Green All for general plastics\n    - Soft brush for crevices\n\n14. Fabric / Carpet / Seats\n    - Carpet Bomber 7:1 (std) or 5:1 (heavy)\n    - Organic stains: Does It All Enzyme Cleaner — dwell 3-5 min, agitate, blot\n    - Straight strokes only with drill brush — never circular\n    - Pet hair tools BEFORE any chemical if hair present\n    - Extractor for Deep Interior Detail or Stain Treatment addon\n\n15. Interior Protectant / Plastics Finisher\n    - P&S Xpress 3:1 or Cover All 4:1\n    - Apply to all plastics/vinyl/trim\n    - Do BEFORE windows so overspray is caught in glass step\n    - If done last: keep away from windshield, screens, electronics\n\n16. Windows & Glass\n    - Invisible Glass on towel only — never spray directly on glass\n    - Two-pass method: first removes film, second clears streaks\n    - Dedicated glass towels only — never shared\n    - Check windshield from multiple angles for haze\n\n17. Door Jambs & Trunk Jambs\n    - Dirt Buster or APC at appropriate dilution\n    - Detail brush for hinges and tight corners\n    - Dry thoroughly — water in jambs drips on paint later\n    - Include hood jamb, trunk jamb, all four door jambs\n\n18. Final Inspection\n    - Sit in driver's seat — check windshield from multiple angles\n    - Confirm jambs clean and dry\n    - Floor mats reinstalled correctly\n    - Interior smells clean, not chemical` 
      },
      { 
        id: 'prime-elite-exterior', 
        chemIds: exteriorIds,
        notes: `Elite Exterior Guide — Step by Step:\n\n1. Wheels & Tires First\n   - Dark Fury 4:1 (light) or 7:1 (heavy)\n   - Agitate with wheel/barrel/lug brush\n   - Rinse immediately — no dwell on metal or chrome\n   - Engine Bay addon: do engine first, cover electronics, rinse, dry before wheels\n\n2. Pre-Rinse\n   - Top to bottom always\n   - Open doors slightly to flush jambs\n   - Skip if clean maintenance detail\n\n3. Pre-Treat Bugs & Heavy Grime\n   - Road Warrior 4:1 on dry surface\n   - Dwell 3-5 min MAX — do not let dry on paint\n   - Focus: front grill, hood, lower front panels\n   - Alternatives: Muscle Magic (heavy grime), Dirt Buster (concentrated spots)\n\n4. Foam Bath\n   - Meguiar's Gold Class 5:1 or Cherry Foam 5:1\n   - Dwell 3-5 min — mist if drying before time is up\n   - Never let foam dry on paint — work in shade\n\n5. Hand Wash (Top to Bottom)\n   - Multiple microfiber towels — flip to clean side each panel\n   - Top to bottom, driver's side front to back, passenger side back to front\n   - Straight strokes only — never circular\n   - Never use wheel/lower panel towel on paint\n\n6. Final Rinse\n   - Top to bottom thoroughly\n   - Clay Bar addon: clay immediately after rinse while paint is wet\n   - Use APC as lubricant, fold clay frequently\n\n7. Drying\n   - Formula 4 at 20:1 sprayed on wet paint\n   - Open all jambs/trunk/hood — dry those too\n   - Formula 4 = drying aid + 2-5 week protection in one step\n\n8. Paint Protection\n   - Apply ceramic / paint sealant enhancement per package level` 
      },
      { 
        id: 'prime-elite-interior', 
        chemIds: interiorIds,
        notes: `Elite Interior Guide — Step by Step:\n\n1. Remove Personal Items & Trash\n   - Remove and set aside safely before starting anything\n\n2. Vacuum (Top to Bottom)\n   - Blow out vents/seat tracks/under seats with air first\n   - Remove floor mats before vacuuming\n   - Work rear to front, crevice tool for tight areas\n\n3. Floor Mats\n   - Drill brush — match brush size/pressure to mat type\n   - Primary: Carpet Bomber 7:1 (std) or 5:1 (heavy) + Terminator\n   - Backup: Zap It\n   - Organic stains: Does It All Enzyme Cleaner — dwell 3-5 min, agitate, wipe\n   - Set aside to dry completely before reinstalling\n\n4. Dashboard, Steering Wheel & Console\n   - Does It All Enzyme Cleaner or Pink Perfection 10:1\n   - Detail brush for vents, button gaps, seams\n   - Driver's side front to back, passenger side back to front\n\n5. Interior Plastics / Vinyl / Trim\n   - Pink Perfection 10:1 general cleaning\n   - Does It All Enzyme Cleaner for organic stains\n   - Green All for general plastics\n   - Soft brush for crevices\n\n6. Fabric / Carpet / Seats\n   - Carpet Bomber 7:1 (std) or 5:1 (heavy)\n   - Organic stains: Does It All Enzyme Cleaner — dwell 3-5 min, agitate, blot\n   - Straight strokes only with drill brush — never circular\n   - Pet hair tools BEFORE any chemical if hair present\n   - Extractor for Deep Interior Detail or Stain Treatment addon\n\n7. Interior Protectant / Plastics Finisher\n   - P&S Xpress 3:1 or Cover All 4:1\n   - Apply to all plastics/vinyl/trim\n   - Do BEFORE windows so overspray is caught in glass step\n   - If done last: keep away from windshield, screens, electronics\n\n8. Windows & Glass\n   - Invisible Glass on towel only — never spray directly on glass\n   - Two-pass method: first removes film, second clears streaks\n   - Dedicated glass towels only — never shared\n   - Check windshield from multiple angles for haze\n\n9. Door Jambs & Trunk Jambs\n   - Dirt Buster or APC at appropriate dilution\n   - Detail brush for hinges and tight corners\n   - Dry thoroughly — water in jambs drips on paint later\n   - Include hood jamb, trunk jamb, all four door jambs\n\n10. Final Inspection\n    - Sit in driver's seat — check windshield from multiple angles\n    - Confirm jambs clean and dry\n    - Floor mats reinstalled correctly\n    - Interior smells clean, not chemical` 
      },
      { 
        id: 'prime-elite-full', 
        chemIds: fullIds,
        notes: `Elite Full Detail Guide — Exterior First, Then Interior:\n\n— EXTERIOR —\n\n1. Wheels & Tires First\n   - Dark Fury 4:1 (light) or 7:1 (heavy)\n   - Agitate with wheel/barrel/lug brush\n   - Rinse immediately — no dwell on metal or chrome\n   - Engine Bay addon: do engine first, cover electronics, rinse, dry before wheels\n\n2. Pre-Rinse\n   - Top to bottom always\n   - Open doors slightly to flush jambs\n   - Skip if clean maintenance detail\n\n3. Pre-Treat Bugs & Heavy Grime\n   - Road Warrior 4:1 on dry surface\n   - Dwell 3-5 min MAX — do not let dry on paint\n   - Focus: front grill, hood, lower front panels\n   - Alternatives: Muscle Magic (heavy grime), Dirt Buster (concentrated spots)\n\n4. Foam Bath\n   - Meguiar's Gold Class 5:1 or Cherry Foam 5:1\n   - Dwell 3-5 min — mist if drying before time is up\n   - Never let foam dry on paint — work in shade\n\n5. Hand Wash (Top to Bottom)\n   - Multiple microfiber towels — flip to clean side each panel\n   - Top to bottom, driver's side front to back, passenger side back to front\n   - Straight strokes only — never circular\n   - Never use wheel/lower panel towel on paint\n\n6. Final Rinse\n   - Top to bottom thoroughly\n   - Clay Bar addon: clay immediately after rinse while paint is wet\n   - Use APC as lubricant, fold clay frequently\n\n7. Drying\n   - Formula 4 at 20:1 sprayed on wet paint\n   - Open all jambs/trunk/hood — dry those too\n   - Formula 4 = drying aid + 2-5 week protection in one step\n\n8. Paint Protection\n   - Apply ceramic / paint sealant enhancement per package level\n\n— INTERIOR —\n\n9. Remove Personal Items & Trash\n   - Remove and set aside safely before starting anything\n\n10. Vacuum (Top to Bottom)\n    - Blow out vents/seat tracks/under seats with air first\n    - Remove floor mats before vacuuming\n    - Work rear to front, crevice tool for tight areas\n\n11. Floor Mats\n    - Drill brush — match brush size/pressure to mat type\n    - Primary: Carpet Bomber 7:1 (std) or 5:1 (heavy) + Terminator\n    - Backup: Zap It\n    - Organic stains: Does It All Enzyme Cleaner — dwell 3-5 min, agitate, wipe\n    - Set aside to dry completely before reinstalling\n\n12. Dashboard, Steering Wheel & Console\n    - Does It All Enzyme Cleaner or Pink Perfection 10:1\n    - Detail brush for vents, button gaps, seams\n    - Driver's side front to back, passenger side back to front\n\n13. Interior Plastics / Vinyl / Trim\n    - Pink Perfection 10:1 general cleaning\n    - Does It All Enzyme Cleaner for organic stains\n    - Green All for general plastics\n    - Soft brush for crevices\n\n14. Fabric / Carpet / Seats\n    - Carpet Bomber 7:1 (std) or 5:1 (heavy)\n    - Organic stains: Does It All Enzyme Cleaner — dwell 3-5 min, agitate, blot\n    - Straight strokes only with drill brush — never circular\n    - Pet hair tools BEFORE any chemical if hair present\n    - Extractor for Deep Interior Detail or Stain Treatment addon\n\n15. Interior Protectant / Plastics Finisher\n    - P&S Xpress 3:1 or Cover All 4:1\n    - Apply to all plastics/vinyl/trim\n    - Do BEFORE windows so overspray is caught in glass step\n    - If done last: keep away from windshield, screens, electronics\n\n16. Windows & Glass\n    - Invisible Glass on towel only — never spray directly on glass\n    - Two-pass method: first removes film, second clears streaks\n    - Dedicated glass towels only — never shared\n    - Check windshield from multiple angles for haze\n\n17. Door Jambs & Trunk Jambs\n    - Dirt Buster or APC at appropriate dilution\n    - Detail brush for hinges and tight corners\n    - Dry thoroughly — water in jambs drips on paint later\n    - Include hood jamb, trunk jamb, all four door jambs\n\n18. Final Inspection\n    - Sit in driver's seat — check windshield from multiple angles\n    - Confirm jambs clean and dry\n    - Floor mats reinstalled correctly\n    - Interior smells clean, not chemical` 
      }
    ];
    ...
    packageAdvice.forEach(advice => {
      ...
      if (existingIdx === -1) {
        ...
        // Update if notes or chemical mapping changed
        if (seededTips[existingIdx].notes !== advice.notes || JSON.stringify(seededTips[existingIdx].chemicalIds) !== JSON.stringify(advice.chemIds)) {
