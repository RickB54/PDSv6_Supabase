...
export const PaintProtectionGuideModal: React.FC<PaintProtectionGuideModalProps> = ({ open, onOpenChange }) => {
  ...
  const handleDownloadPDF = () => {
    try {
      ...
      doc.roundedRect(12, currentY, pageWidth - 24, 18, 2, 2, 'FD');
      
      doc.setFontSize(10.5);
      doc.setFont('helvetica', 'bold');
      doc.setTextColor(185, 28, 28);
      doc.text('CORE PRINCIPLE: "Clean the surface before you judge the protection."', 16, currentY + 7);
      doc.setFontSize(8);
      doc.setFont('helvetica', 'italic');
      doc.setTextColor(100, 116, 139);
      doc.text('Origination: Generated by Claude (Anthropic) for Prime Auto Detail, September 17, 2026', 16, currentY + 13);
      currentY += 22;
      ...
      doc.text('1. Ceramic Coatings vs. Traditional Sealants & Waxes', 14, currentY);
      currentY += 6;
      doc.setFontSize(9);
      doc.setFont('helvetica', 'normal');
      doc.setTextColor(51, 65, 85);
      const s1 = doc.splitTextToSize('Traditional carnauba waxes and synthetic poly sealants sit on top of the clear coat like a temporary layer, offering 1-6 months of protection. Ceramic coatings (SiO2/SiC) form a semi-permanent chemical bond directly with the clear coat lattice, creating a glass-like barrier lasting 2-5+ years.', pageWidth - 28);
      ...
      doc.setFont('helvetica', 'bold');
      doc.setTextColor(30, 58, 138);
      doc.text('2. Hydrophobicity & Surface Contact Angle', 14, currentY);
      currentY += 6;
      doc.setFontSize(9);
      doc.setFont('helvetica', 'normal');
      doc.setTextColor(51, 65, 85);
      const s2 = doc.splitTextToSize('Hydrophobicity is measured by water contact angle. High contact angle (>100°) produces tight, round water beads that easily roll off the panel (superhydrophobic effect). Low contact angle causes water to sheet or pool flat.', pageWidth - 28);
      doc.text(s2, 14, currentY);
      currentY += s2.length * 4.5 + 6;
      ...
      doc.setFont('helvetica', 'bold');
      doc.setTextColor(30, 58, 138);
      doc.text('3. Hose Test & Flood Sheeting Protocol', 14, currentY);
      currentY += 6;
      const s3 = doc.splitTextToSize('Perform the open-hose flood test to evaluate true hydrophobic performance. Remove the nozzle and flood the panel from top to bottom at medium flow. A fully protected surface will clean-sheet, leaving under 5% water droplets behind.', pageWidth - 28);
      doc.text(s3, 14, currentY);
      currentY += s3.length * 4.5 + 6;
      ...
      toast({ title: 'PDF Exported', description: 'Paint Protection & Hydrophobicity Training Guide downloaded successfully.' });
    } catch (e: any) {
