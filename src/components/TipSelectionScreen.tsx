  ...
  return (
    <div className="fixed inset-0 z-[100] bg-gray-900/80 backdrop-blur-sm flex flex-col items-center animate-in fade-in duration-300 p-2 sm:p-4 overflow-y-auto">
      <div className="w-full max-w-lg bg-white rounded-3xl flex flex-col shadow-2xl relative overflow-hidden max-h-[92vh] my-auto shrink-0">
          ...
          {!loading && (
            <>
              <button 
                ...
                className={`absolute top-3 right-12 p-2 rounded-full transition-colors ${showInfo ? 'text-blue-600 bg-blue-100' : 'text-gray-400 hover:text-blue-600 hover:bg-blue-50'}`}
        ...
        <div className="p-4 sm:p-6 flex-1 overflow-y-auto w-full pb-6 styled-scrollbar relative">
          {showInfo && (
            <div className="absolute top-4 left-4 right-4 z-30 rounded-2xl border border-blue-200 bg-gradient-to-b from-blue-50 to-indigo-50 text-blue-900 overflow-hidden shadow-2xl animate-in slide-in-from-top-2 fade-in duration-200">
              <div className="px-4 pt-3 pb-2 border-b border-blue-200/60 bg-blue-50/90 backdrop-blur-xs">
              ...
              <div className="px-4 py-3 flex flex-col gap-3 pb-4">
                {isAdmin && (
                ...
                {isAdmin && (
                  <button onClick={() => { onCancel(); window.location.href='/invoicing'; }} className="mt-1 w-full text-center py-2 bg-blue-100 rounded-lg text-xs font-bold text-blue-800 hover:bg-blue-200 transition-colors">
