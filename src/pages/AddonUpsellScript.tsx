                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <Select value={vehicleType} onValueChange={setVehicleType}>
                                        ...
                                        <SelectContent className="bg-zinc-800 border-zinc-700">
                                            <SelectItem value="Compact/Sedan" className="text-white">Compact/Sedan</SelectItem>
                                            <SelectItem value="Mid-Size/SUV" className="text-white">Mid-Size/SUV</SelectItem>
                                            <SelectItem value="Truck/Van/Large SUV" className="text-white">Truck/Van/Large SUV</SelectItem>
                                            <SelectItem value="Luxury/High-End" className="text-white">Luxury/High-End</SelectItem>
                                        </SelectContent>
                                    </Select>
                                </div>
                                <div>
